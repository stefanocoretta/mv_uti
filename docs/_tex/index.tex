...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colback=white, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, rightrule=.15mm, left=2mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm]
...
by DeepLabCut. CC-BY Wrench and Balch-Tomes (A. A. Wrench 2024).}
