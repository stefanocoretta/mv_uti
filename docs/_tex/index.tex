...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, colback=white, opacitybacktitle=0.6, breakable, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, bottomtitle=1mm, coltitle=black, rightrule=.15mm]
