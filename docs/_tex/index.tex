...
\hypersetup{
  pdftitle={Multivariate analyses of tongue contours from ultrasound tongue imaging. Draft v0.4},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, breakable, colframe=quarto-callout-warning-color-frame, left=2mm, bottomrule=.15mm, colback=white, toptitle=1mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, titlerule=0mm, opacitybacktitle=0.6, rightrule=.15mm]
...
Arabic. The data is from XXX. {[}XXX TODO GEORGE description of the
data, including a brief explanation of the LebAr context{]}.
