...
The second case study is about consonant "emphaticness" in Lebanese Arabic. The data is from @sakr2025.
...
Based on the advantages and disadvantages of each of multivariate GAMs and FPCA, we suggest for researchers to use MFPCA as the preferred and default approach to analyse DLC-tracked tongue contour data and to resort to multivariate GAMs if MFPCA fails to capture relevant variation.
